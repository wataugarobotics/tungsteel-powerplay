...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -2.46; // X is the up and down direction
    public static double PARALLEL_Y = -0.59; // Y is the strafe direction

    public static double PERPENDICULAR_X = -2.65; // in
    public static double PERPENDICULAR_Y = 6.47;

    // yes, it was actually this perfect
